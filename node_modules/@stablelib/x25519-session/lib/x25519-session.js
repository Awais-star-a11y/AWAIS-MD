 ...
 */
export function serverSessionKeysFromSharedKey(sharedKey, myPublicKey, theirPublicKey, hash = BLAKE2b) {
 ...
 */
export function clientSessionKeysFromSharedKey(sharedKey, myPublicKey, theirPublicKey, hash = BLAKE2b) {
    const state = new hash();
    if (state.digestLength !== SESSION_KEY_LENGTH * 2) {
        throw new Error("X25519: incorrect digest length");
    }
 ...
 */
export function serverSessionKeys(myKeyPair, theirPublicKey, hash = BLAKE2b) {
 ...
 */
export function clientSessionKeys(myKeyPair, theirPublicKey, hash = BLAKE2b) {
    const sk = deriveSharedKey(myKeyPair.secretKey, theirPublicKey);
